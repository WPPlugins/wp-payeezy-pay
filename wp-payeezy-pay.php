...
Version: 2.80
Plugin URI: https://richard-rottman.com/
...
Author URI: https://richard-rottman.com/
*/
...
// Testing.
    ...
    $pay_file = plugins_url('wp-payeezy-pay/test.php'); 
}
...
function wppayeezypay_no_transaction_key() {  
      ...
      // Begin process of saving the transaction key to a separate php file.
...
#settingsDiv {
  ...
  <h2>WP Payeezy Pay version 2.80</h2>
  ...
  <div id="leftColumn">
    <form method="post" action="options.php">
      ...
      <!-- shortcode column -->
       <div id="shortcodeDiv">
       <h3>Shortcode</h3>
      <p>This plugin create a payment or donation form that integrate with First Data Payeezy. To add this form to a page or post, add the following <a href="https://codex.wordpress.org/Shortcode" target="_blank">shortcode</a> in the body of the page or post:</p>
      ...
      <!-- settings column -->
      <div id="settingsDiv">
      <p>Click on a field name to learn more about it. You can also <a href="mailto:info@richard-rottman.com?Subject=Help%20setting%20up%20WP%20Payeezy%20Pay" target="_top">contact me</a> if you have any other questions.</p>
      <br>
       <h3>Required Settings</h3>
      <table class="form-table">
      <tr valign="top">
        <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#PaymentPageID" target="_blank">Payment Page ID</a></th>
      ...
      <tr valign="top">
      <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#TransactionKey" target="_blank">Transaction Key</a></th>  
      ...
      <tr valign="top">
      <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#CurrencyCode" target="_blank">Currency Code</a></th>  
      ...
      <tr valign="top">
        <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#Mode" target="_blank">Mode</a></th>  
      ...
      <tr valign="top">
        <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#TypeofTransactions" target="_blank">Type of Transactions</a></th>  
      ...
      <tr valign="top">
        <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#buttonText" target="_blank">Button Text</a></th>  
         <td><select name="button_text"/>
            ...
            <option value="continue-to-secure-donation" <?php if( get_option('button_text') == "continue-to-secure-donation" ): echo 'selected'; endif;?> >Continue to Secure Payment Form</option>
            </select>
      </tr>
    ...
    <hr>
      ...
      <table class="form-table">
     <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#ResponseKey" target="_blank">Response Key</a></th>  
        ...
        <p>Used for <strong><a href="https://richard-rottman.com/wp-payeezy-results/" target="_blank" >WP Payeezy Results</a></strong>.</p></td> 
      </tr>
      
      <tr valign="top">
      <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#Amount" target="_blank">Amount</a></th>  
        
       <td valign="top"><span class="large">$</span> <input type="text" class="x_amount" name="x_amount" value="<?php echo esc_attr( get_option('x_amount') ); ?>" /><br>If an amount is entered above, the card holder will not have the option of entering an amount. They will be charged what you enter here.</td></tr>

      
      <tr valign="top">
       <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#Recurring" target="_blank">Monthly Recurring Billing ID</a></th>  
    ...
    <table class="form-table">
      <tr valign="top"> If you would like to use any of these fields, just assign a name to them
        and they will appear on your form with that name. Do not assign a name, and they will not appear. To make the field a required field, check the box next to the name of the field. If the box is checked, the cardholder cannot proceed to Payeezy until they enter a value. </tr>
      <tr valign="top">
        <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#x_invoice_num" target="_blank">x_invoice_num</a></th>
        <td><input type="text" name="x_invoice_num" value="<?php echo esc_attr( get_option('x_invoice_num') ); ?>" /></td>
      </tr>
      <tr valign="top">
      <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#x_po_num" target="_blank">x_po_num</a></th>
      <td><input type="text" name="x_po_num" value="<?php echo esc_attr( get_option('x_po_num') ); ?>" /></td>
      </tr>
      <tr valign="top">
      <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#x_reference_3" target="_blank">x_reference_3</a></th>
      <td><input type="text" name="x_reference_3" value="<?php echo esc_attr( get_option('x_reference_3') ); ?>" /></td>
      </tr>
      <tr valign="top">
        <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#x_user1" target="_blank">x_user1</a></th>
        <td><input type="text" name="x_user1" value="<?php echo esc_attr( get_option('x_user1') ); ?>" /></td>
      </tr>
      <tr valign="top">
        <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#x_user1" target="_blank">x_user2</a></th>
        <td><input type="text" name="x_user2" value="<?php echo esc_attr( get_option('x_user2') ); ?>" /></td>
      </tr>
      <tr valign="top">
        <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#x_user1" target="_blank">x_user3</a></th>
       
        <td><input type="text" name="x_user3" value="<?php echo esc_attr( get_option('x_user3') ); ?>" /></td>
      </tr>
      <tr valign="top">
       <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#x_phone" target="_blank">x_phone</a></th>
        <td><input type="text" name="x_phone" value="<?php echo esc_attr( get_option('x_phone') ); ?>" /></td>
      </tr>
      <tr valign="top">
        <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#x_email" target="_blank">x_email</a></th>
        <td><input type="text" name="x_email" value="<?php echo esc_attr( get_option('x_email') ); ?>" /></td>
     </tr>
      <tr valign="top">
      <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#x_description" target="_blank">x_description</a></th>
      <td><input type="text" name="x_description" value="<?php echo esc_attr( get_option('x_description') ); ?>" /></td>
      </tr>
      <tr valign="top">
        <th scope="row"><a href="https://richard-rottman.com/wp-payeezy-pay-fields/#x_company" target="_blank">x_company</a></th>
        <td><input type="text" name="x_company" value="<?php echo esc_attr( get_option('x_company') ); ?>" /></td>
   ...
   submit_button('Save WP Payeezy Pay Settings'); 
...
?>
 ...
 <div id="blueDiv">
<h3><a href="https://richard-rottman.com/payeezy-custom/" target="_blank"><span class="dashicons dashicons-hammer"></span>&nbsp;Customization & Modification</a></h3>
<p>I can customize and modify <strong>WP Payeezy Pay</strong> to your specific needs.</p>
<p><a class="button-primary" href="https://richard-rottman.com/payeezy-custom//">Request Customization</a></p>
 </div>
 <div id="blueDiv">

<h3><a href="https://richard-rottman.com/wp-payeezy-results/" target="_blank"><span class="dashicons dashicons-admin-plugins"></span>&nbsp;WP Payeezy Results</a></h3>
<p><strong>WP Payeezy Results</strong> is a premium plugin that allows First Data Payeezy to send transaction information back to WordPress.</p>
<p>Have you ever logged into First Data Payeezy and tried to get a cardholder's email address, phone number, address, or information linked to custom fields? You can't. First Data Payeezy does <strong>not</strong> retain this information. <strong>WP Payeey Results</strong> does.</p>
<p><a class="button-primary" href="https://richard-rottman.com/wp-payeezy-results/" target="_blank">Find out More</a></p>
</div>
</div>
<?php } ?>